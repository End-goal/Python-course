...
# -------------- units --------------
    ...
    cursor.execute("INSERT INTO units VALUES('u5', 'it1', 'shaman', 200)")
...
# -------------- armor --------------
    ...
    cursor.execute("INSERT INTO armor VALUES('h1', 'it2', 'at1', 'wooden helmet', 'ALL', 200, 400)")
    cursor.execute("INSERT INTO armor VALUES('h2', 'it2', 'at1', 'iron helmet', 'ALL', 300, 600)")
    cursor.execute("INSERT INTO armor VALUES('h3', 'it2', 'at1', 'steel helmet', 'ALL', 400, 800)")

    cursor.execute("INSERT INTO armor VALUES('ba1', 'it2', 'at2', 'wooden bodyarmor', 'ALL', 200, 400)")
    cursor.execute("INSERT INTO armor VALUES('ba2', 'it2', 'at2', 'iron bodyarmor', 'ALL', 300, 600)")
    cursor.execute("INSERT INTO armor VALUES('ba3', 'it2', 'at2', 'steel bodyarmor', 'ALL', 400, 800)")

    cursor.execute("INSERT INTO armor VALUES('b1', 'it2', 'at3', 'wooden boots', 'ALL', 200, 400)")
    cursor.execute("INSERT INTO armor VALUES('b2', 'it2', 'at3', 'iron boots', 'ALL', 300, 600)")
    cursor.execute("INSERT INTO armor VALUES('b3', 'it2', 'at3', 'steel boots', 'ALL', 400, 800)")

    cursor.execute("INSERT INTO armor VALUES('s1', 'it2', 'at4', 'wooden shield', 'ALL', 200, 400)")
    cursor.execute("INSERT INTO armor VALUES('s2', 'it2', 'at4', 'iron shield', 'ALL', 300, 600)")
    cursor.execute("INSERT INTO armor VALUES('s3', 'it2', 'at4', 'steel shield', 'ALL', 400, 800)")
